...
import { SOMNIA_EXPLORER_URL, getContractAddress, getExplorerAddressUrl } from "@/lib/chain";
          ...
          {hasEvidence && (
            <div>
              ...
              <p className="mt-1 text-[11px] text-pv-muted">
                The oracle fetched the evidence URL, hashed it with keccak256, and stored this hash on Somnia.
          ...
          <div className="rounded-xl border border-pv-ink/[0.06] bg-pv-ink/[0.02] px-3 py-2">
            ...
            <ol className="text-[11px] text-pv-muted space-y-0.5 list-decimal list-inside">
              ...
              <li>
                ...
                >
                  View Mimir contract on the Somnia explorer ↗
                </a>
                {" "}
                <span className="text-pv-muted/70">({SOMNIA_EXPLORER_URL})</span>
              </li>
            </ol>
          </div>
        </div>
