...
const EN_SEEDS: SeedChallengeOpportunity[] = [
  {
    id: "seed-miami-gp",
    sourceUrl: "https://www.formula1.com/en/racing/2027/Miami",
    sourceType: "official",
    sourceSummary:
    ...
    candidate: {
      category: "sports",
      claimText: "Will Kimi Antonelli win the 2027 Formula 1 Crypto.com Miami Grand Prix?",
      sideA: "Kimi Antonelli is listed as the official race winner",
      sideB: "Any other driver is listed as the official race winner",
      deadlineAt: "2027-05-02T23:59:00.000Z",
      timezone: "UTC",
      primaryResolutionSource: "https://www.formula1.com/en/racing/2027/Miami",
      settlementRule:
        "Resolve this using the official final classification on Formula1.com for the 2027 Miami Grand Prix. If Kimi Antonelli is listed first in the final classified race results, Side A wins.",
      ambiguityFlags: [],
      confidenceScore: 93,
    },
  },
  {
    ...
    candidate: {
      category: "weather",
      claimText: "Will rain be reported for Buenos Aires on December 15, 2026?",
      sideA: "Rain is reported for Buenos Aires on December 15, 2026",
      sideB: "No rain is reported for Buenos Aires on December 15, 2026",
      deadlineAt: "2026-12-15T23:00:00.000Z",
      timezone: "UTC",
      primaryResolutionSource: "https://weather.com/weather/tenday/l/ARBA0009:1:AR",
      settlementRule:
        "Resolve this using the December 15, 2026 Buenos Aires daily weather entry on the linked forecast page. If rain or showers are reported for that day, Side A wins.",
      ambiguityFlags: [],
      confidenceScore: 86,
    },
  },
  {
    ...
    candidate: {
      category: "crypto",
      claimText: "Will BTC trade above $100,000 before December 31, 2026?",
      sideA: "BTC trades above $100,000 before December 31, 2026",
  ...
  },
  {
    ...
    candidate: {
      category: "crypto",
      claimText: "Will ETH trade above $5,000 before December 31, 2026?",
      sideA: "ETH trades above $5,000 before December 31, 2026",
  ...
  },
  {
    ...
    candidate: {
      category: "custom",
      claimText: "Will Apple announce a new iPad before December 31, 2026?",
      sideA: "Apple announces a new iPad before December 31, 2026",
      sideB: "Apple does not announce a new iPad before December 31, 2026",
      deadlineAt: "2026-12-31T23:59:00.000Z",
      timezone: "UTC",
      primaryResolutionSource: "https://www.apple.com/newsroom/",
      settlementRule:
        "Resolve this only from Apple Newsroom at the deadline. If an official Apple post published on or before December 31, 2026 announces a new iPad model, Side A wins.",
      ambiguityFlags: [],
      confidenceScore: 87,
    },
  },
  {
    ...
    candidate: {
      category: "custom",
      claimText: "Will OpenAI publish a GPT-7 announcement before December 31, 2026?",
      sideA: "OpenAI publishes a GPT-7 announcement before December 31, 2026",
      sideB: "OpenAI does not publish a GPT-7 announcement before December 31, 2026",
      deadlineAt: "2026-12-31T23:59:00.000Z",
      timezone: "UTC",
      primaryResolutionSource: "https://openai.com/news/",
      settlementRule:
        "Resolve this only from OpenAI News at the deadline. If an official post published on or before December 31, 2026 explicitly announces GPT-7, Side A wins.",
      ambiguityFlags: [],
      confidenceScore: 84,
    },
  },
...
const ES_SEEDS: SeedChallengeOpportunity[] = [
  {
    ...
    candidate: {
      category: "sports",
      claimText: "¿Kimi Antonelli ganará el FORMULA 1 CRYPTO.COM MIAMI GRAND PRIX 2027?",
  ...
  },
  {
    ...
    candidate: {
      category: "weather",
      claimText: "¿Se reportará lluvia para Buenos Aires el 15 de diciembre de 2026?",
  ...
  },
  {
    ...
    candidate: {
      category: "crypto",
      claimText: "¿BTC cotizará por encima de $100,000 antes del 31 de diciembre de 2026?",
      sideA: "BTC cotiza por encima de $100,000 antes del 31 de diciembre de 2026",
  ...
  },
  {
    ...
    candidate: {
      category: "crypto",
      claimText: "¿ETH cotizará por encima de $5,000 antes del 31 de diciembre de 2026?",
      sideA: "ETH cotiza por encima de $5,000 antes del 31 de diciembre de 2026",
  ...
  },
  {
    ...
    candidate: {
      category: "custom",
      claimText: "¿Apple anunciará un nuevo iPad antes del 31 de diciembre de 2026?",
      sideA: "Apple anuncia un nuevo iPad antes del 31 de diciembre de 2026",
      sideB: "Apple no anuncia un nuevo iPad antes del 31 de diciembre de 2026",
      deadlineAt: "2026-12-31T23:59:00.000Z",
      timezone: "UTC",
      primaryResolutionSource: "https://www.apple.com/newsroom/",
      settlementRule:
        "Resuelve esto solo con Apple Newsroom al deadline. Si una publicacion oficial de Apple publicada en o antes del 31 de diciembre de 2026 anuncia un nuevo modelo de iPad, gana el Lado A.",
      ambiguityFlags: [],
      confidenceScore: 87,
    },
  },
  {
    ...
    candidate: {
      category: "custom",
      claimText: "¿OpenAI publicará un anuncio de GPT-7 antes del 31 de diciembre de 2026?",
      sideA: "OpenAI publica un anuncio de GPT-7 antes del 31 de diciembre de 2026",
      sideB: "OpenAI no publica un anuncio de GPT-7 antes del 31 de diciembre de 2026",
      deadlineAt: "2026-12-31T23:59:00.000Z",
      timezone: "UTC",
      primaryResolutionSource: "https://openai.com/news/",
      settlementRule:
        "Resuelve esto solo con OpenAI News al deadline. Si una publicacion oficial publicada en o antes del 31 de diciembre de 2026 anuncia explicitamente GPT-7, gana el Lado A.",
      ambiguityFlags: [],
      confidenceScore: 84,
    },
  },
